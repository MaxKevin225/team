...
I've been always thinking about launching my own website with my custom domain name (**smartoutsourcingservice.icu**) since my college student life. But that never happened until this project. I've done several projects and works about web application development but I didn't make an effort to do this.
...
![searching smartoutsourcingservice.icu on google](https://res.cloudinary.com/noezectz/image/upload/v1648231400/Hiroshi/Hiroshi-on-google_asflq6.png "smartoutsourcingservice.icu is indexed")

Moreover, this website will be displayed well when shared to social media due to properly used meta tags.

![smartoutsourcingservice.icu card layout when shared to Facebook](https://res.cloudinary.com/noezectz/image/upload/v1653106955/Hiroshi/Hiroshi-dev-share-on-facebook_1_zjoehx.png "Card layout when shared to Facebook")
...
![smartoutsourcingservice.icu Lighthouse score](https://user-images.githubusercontent.com/53733092/159957822-7082e459-11e9-4616-8f1e-49d0881f7cbb.png "smartoutsourcingservice.icu Lighthouse score")
...
![animations at smartoutsourcingservice.icu](https://res.cloudinary.com/noezectz/image/upload/v1653108324/Hiroshi/ezgif.com-gif-maker_2_hehtlm.gif "smartoutsourcingservice.icu website")
...
- Website: [https://smartoutsourcingservice.icu/](https://smartoutsourcingservice.icu/ "https://smartoutsourcingservice.icu/")
- Blog: [https://smartoutsourcingservice.icu/blog](https://smartoutsourcingservice.icu/blog "https://smartoutsourcingservice.icu/blog")
